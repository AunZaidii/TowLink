...
export function DesktopPlansPage() {
  ...
  const faqs = [
    {
      ...
      answer:
        "Repair costs are handled separately unless stated in your plan. TowLink covers towing and coordination services.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "We currently cover all major cities in Pakistan including Karachi, Lahore, Islamabad, and surrounding areas. Coverage varies by plan.",
    },
    {
      question: "How quickly can I get assistance?",
      answer:
        "Response times vary by plan: Basic (48 hours), Plus (same day), Premium (within 30 minutes). All plans include 24/7 emergency contact.",
    },
    {
      question: "Can I add multiple vehicles?",
      answer:
        "Yes! You can add multiple vehicles to your subscription at a discounted rate. Contact our support team for multi-vehicle pricing.",
    },
  ];
            ...
            {plans.map((plan) => (
              ...
              >
                ...
                <CardHeader className="p-0 mb-6">
                  <CardTitle className="text-[22px] font-semibold mb-4">
                    {plan.name}
                  </CardTitle>
                ...
                <CardContent className="p-0">
                  <ul className="space-y-3 mb-6">
                    {plan.features.map((feature, idx) => (
                      <li
                        key={idx}
                        className="text-sm flex items-start gap-2 leading-[22px]"
                      >
